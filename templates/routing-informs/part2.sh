...
Press return to create an experiment on the production and staging instances
using the input set generated by this script.
EOF
read -r
...
status of experiments as well as more details on and visualizations of
the results from completed experiments.
