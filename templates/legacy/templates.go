...
var (
	...
	// MipKnapsackMain is the main.go file in the knapsack-mip template.
	//go:embed mip-knapsack/main.go
	MipKnapsackMain string
	// MipKnapsackInput is the input.json file in the knapsack-mip template.
	//go:embed mip-knapsack/input.json
	MipKnapsackInput string
	// MipKnapsackReadme is the README.md file in the knapsack-mip template.
	//go:embed mip-knapsack/README.md
	MipKnapsackReadme string
