...
func ExampleDependentIndexed() {
	...
	measures := []route.ByIndex{indexed1, indexed2}
	...
	fmt.Println(dependentMeasure.Cost(0, 1, &route.VehicleData{
		Index: 0,
		Times: route.Times{
			EstimatedDeparture: etds,
		},
	}))
	fmt.Println(dependentMeasure.Cost(1, 0, &route.VehicleData{
		Index: 1,
		Times: route.Times{
			EstimatedDeparture: etds,
		},
