module github.com/nextmv-io/sdk/route/routingkit

go 1.19

replace github.com/nextmv-io/sdk => ../../.

replace github.com/nextmv-io/sdk/measure/routingkit => ../../measure/routingkit

require (
	github.com/nextmv-io/go-routingkit v0.1.18
	github.com/nextmv-io/sdk v1.0.3
	github.com/nextmv-io/sdk/measure/routingkit v1.0.3
)
