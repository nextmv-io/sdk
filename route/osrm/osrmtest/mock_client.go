...
func (mr *MockClientMockRecorder) Get(uri interface{}) *gomock.Call {
...
func (mr *MockClientMockRecorder) IgnoreEmpty(ignore interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) MaxTableSize(size interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) Polyline(points interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) ScaleFactor(factor interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) SnapRadius(radius interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) Table(points interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{points}, opts...)
